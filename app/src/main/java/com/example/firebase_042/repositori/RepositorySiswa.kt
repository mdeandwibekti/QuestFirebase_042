package com.example.firebase_042.repositori
...
class FirebaseRepositorySiswa : RepositorySiswa {
    ...
    override suspend fun postDataSiswa(siswa: Siswa) {
        ...
        val data = hashMapOf(
            "id" to (if (siswa.id != 0L) siswa.id else docRef.id.hashCode()),
            "nama" to siswa.nama,
    ...
    override suspend fun getSatuSiswa(id: Long): Siswa? { // Return type disesuaikan jadi nullable/handled
        return try {
